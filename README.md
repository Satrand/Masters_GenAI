...
This directory contains the implementation of the conditional variational autoencoder (CVAE) used for molecular generation. The model architecture was developed by another member of the research group and was trained using the dataset generated by the processing pipeline.
